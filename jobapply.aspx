<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="jobapply.aspx.cs" Inherits="OpenOffice.WebForm6" %>
...
<div class="container-fluid" style="background-image:url(images/job2.jpg);background-repeat: no-repeat; background-size: cover; background-position: center center; padding-bottom:40px; margin-bottom:-15px;">
    ...
    <div class="row">
        ...
        <div class="col-sm-6" style="margin-top:100px; margin-bottom:35px; height:auto; box-shadow: 0 0 11px rgba(33,33,33,.2); ">
            <center><h3 style= "font:bold; font-family: 'Raleway', sans-serif; color:#404040;padding-top:20px;">APPLY FOR A JOB!!</h3></center>
            <hr/>
                    ...
                    <div>
                     <table align="center">
                        <tr>
                            ...
                            <b>First Impressoion Matters</b><p>Having trouble in writing Resume? Do check <a href="Resume.aspx">Resume Tips</a></p><br />
                            </td>
                        </tr>
                        <tr>
                            <th>From:</th>
